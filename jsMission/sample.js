$(document).ready(function(){
  ...
  function get_achievement(){
    ...
    // sum = sum + subject_points[3];
    // sum = sum + subject_points[4];
    // let average_point = sum / subject_points.length
    let average_point = ave;
      
     $('#btn-evaluation').click(function(){
        var judge = 0;
        if(average_point >= 80) {
            judge = "A";
        } else if(average_point >= 60 && average_point < 79) {
            judge = "B";
        } else if(average_point >= 40 && average_point < 59) {
            judge = "C";
        } else if(average_point < 39) {
            judge = "D";
        }
